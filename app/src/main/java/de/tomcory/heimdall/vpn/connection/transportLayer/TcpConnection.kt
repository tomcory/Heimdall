...
class TcpConnection internal constructor(
     ...
     */
    fun increaseTheirSeqNum(increase: Int) {
     ...
     */
    fun increaseOurSeqNum(increase: Int) {
     ...
     */
    fun buildTcpPayload(urg: Boolean, ack: Boolean, psh: Boolean, rst: Boolean, syn: Boolean, fin: Boolean, rawPayload: ByteArray): TcpPacket.Builder {
     ...
     */
    fun buildSynAck(): TcpPacket.Builder {
     ...
     */
    fun buildEmptyAck(): TcpPacket.Builder {
     ...
     */
    fun buildDataAck(rawPayload: ByteArray): TcpPacket.Builder {
     ...
     */
    fun buildRst(): TcpPacket.Builder {
     ...
     */
    fun buildFin(): TcpPacket.Builder {
     ...
     */
    fun buildFinAck(): TcpPacket.Builder {
