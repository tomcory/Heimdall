...
import de.tomcory.heimdall.vpn.metadata.AppFinder
...
class ComponentManager(
    ...
    init {
         ...
         */
        deviceWriteThread = DeviceWriteThread("DeviceWriteThread", inboundStream) { deviceWriter ->
            inboundTrafficHandler = InboundTrafficHandler("InboundTrafficHandler", this)
            outboundTrafficHandler = OutboundTrafficHandler("OutboundTrafficHandler", deviceWriter, this) { outHandler ->
                devicePollThread = DevicePollThread("DevicePollThread", outboundStream, interrupter, outHandler)
